  ...
  return (
    <section ref={sectionRef} className="relative py-32 px-4">
      <div className="max-w-3xl mx-auto text-center">
        <span className="inline-block text-xs font-mono uppercase tracking-widest text-accent mb-6 discovery-item">Discovery</span>
        <h2 className="section-heading mb-6 discovery-item">The first encounter with LLMs</h2>
        <div ref={itemsRef} className="space-y-6">
          <p className="text-text-tertiary text-lg leading-relaxed discovery-item">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 discovery-item">
          ...
          <p className="text-text-secondary text-base leading-relaxed discovery-item">
