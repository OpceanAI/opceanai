  ...
  return (
    <section id="system" ref={sectionRef} className="relative py-32 px-4">
      <div className="max-w-3xl mx-auto text-center">
        <span className="inline-block text-xs font-mono uppercase tracking-widest text-accent mb-6 doki-item opacity-0">Current Product</span>
        <h2 className="section-heading mb-6 doki-item opacity-0">Doki</h2>
        <p className="text-text-tertiary text-lg leading-relaxed max-w-xl mx-auto mb-4 doki-item opacity-0">
          Launched in May 2026. Doki is a system focused on bringing Docker containers to Android.
        </p>
        <p className="text-text-secondary text-base leading-relaxed max-w-lg mx-auto mb-12 doki-item opacity-0">
        ...
        <div ref={itemsRef} className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {features.map((f) => (
            <div key={f.title} className="doki-item opacity-0 glass-panel glass-spotlight p-6 text-left">
